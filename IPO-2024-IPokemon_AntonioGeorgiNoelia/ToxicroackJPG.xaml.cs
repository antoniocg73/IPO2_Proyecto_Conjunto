...
namespace Pokemon_Antonio_Campallo_Gomez
{
    public sealed partial class ToxicroackJPG : UserControl, iPokemon
    {
        ...
        public string Nombre { get => "Toxicroak"; set => throw new NotImplementedException(); }
        public string Categoría { get => "Boca Tóxica"; set => throw new NotImplementedException(); }
        public string Tipo { get => "Veneno/Lucha"; set => throw new NotImplementedException(); }
        public double Altura { get => Convert.ToDouble(1.3); set => throw new NotImplementedException(); }
        public double Peso { get => Convert.ToDouble(44.4); set => throw new NotImplementedException(); }
        public string Evolucion { get => "No tiene"; set => throw new NotImplementedException(); }
        public string Descripcion { get => "Esquiva ágilmente los ataques de sus enemigos mientras va acortando distancias para contraatacar con sus garras venenosas."; set => throw new NotImplementedException(); }
       ...
       /* private void CoreWindow_KeyDown(Windows.UI.Core.CoreWindow sender, Windows.UI.Core.KeyEventArgs args)
        ...
        public void verFilaVida(bool ver)
        {
            if (ver)
            {
                ...
                img_Vida.Visibility = Visibility.Visible;
            ...
            else
            {
                ...
                img_Vida.Visibility = Visibility.Collapsed;
            }
        }
        ...
        public void verFilaEnergia(bool ver)
        {
            if (ver)
            {
                ...
                img_Energia.Visibility = Visibility.Visible;
            ...
            else
            {
                ...
                img_Energia.Visibility = Visibility.Collapsed;
            }
        }
        ...
        public void animacionAtaqueFlojo()
        {
            ...
            mpSonidos.Source = MediaSource.CreateFromUri(new Uri($"ms-appx:///AssetsToxicroackJPG/AtaqueDebil2.mp3"));
        ...
        public void animacionAtaqueFuerte()
        {
            ...
            mpSonidos.Source = MediaSource.CreateFromUri(new Uri($"ms-appx:///AssetsToxicroackJPG/AtaqueFuerte.mp3"));
            // Reproducir el sonido
            mpSonidos.Play();
        }
        ...
        public void animacionDescasar()
        {
            ...
            MediaPlayer mpSonidos = new MediaPlayer();
            mpSonidos.Source = MediaSource.CreateFromUri(new Uri($"ms-appx:///AssetsToxicroackJPG/Ronquido.mp3"));
            // Reproducir el sonido
            mpSonidos.Play();
        ...
        public void animacionCansado()
        {
            ...
            MediaPlayer mpSonidos = new MediaPlayer();
            mpSonidos.Source = MediaSource.CreateFromUri(new Uri($"ms-appx:///AssetsToxicroackJPG/Bostezo.mp3"));
            // Reproducir el sonido
            mpSonidos.Play();
        ...
        public void animacionHerido()
        {
            ...
            MediaPlayer mpSonidos = new MediaPlayer();
            mpSonidos.Source = MediaSource.CreateFromUri(new Uri($"ms-appx:///AssetsToxicroackJPG/Herido.mp3"));
            // Reproducir el sonido
            mpSonidos.Play();
        ...
        public void animacionDerrota()
        {
            ...
            MediaPlayer mpSonidos = new MediaPlayer();
            mpSonidos.Source = MediaSource.CreateFromUri(new Uri($"ms-appx:///AssetsToxicroackJPG/Muerte.mp3"));
            // Reproducir el sonido
            mpSonidos.Play();
        }
