...
namespace Pokemon_Antonio_Campallo_Gomez
{
    public sealed partial class Lapras : UserControl, iPokemon
    {
        ...
        public void animacionAtaqueFlojo()
        {
            ...
            this.sonidos.Source = MediaSource.CreateFromUri(new Uri("ms-appx:///AssetsLaprasACE/AtaqueDebil.mp3"));
        ...
        public void animacionAtaqueFuerte()
        {
            ...
            this.sonidos.Source = MediaSource.CreateFromUri(new Uri("ms-appx:///AssetsLaprasACE/AtaqueFuerte.mp3"));
            sonidos.MediaPlayer.Play();
        }
        ...
        public void animacionDefensa()
        {
            ...
            this.sonidos.Source = MediaSource.CreateFromUri(new Uri("ms-appx:///AssetsLaprasACE/Escudo.mp3"));
            sonidos.MediaPlayer.Play();
        }
        ...
        public void animacionDescasar()
        {
            ...
            this.sonidos.Source = MediaSource.CreateFromUri(new Uri("ms-appx:///AssetsLaprasACE/Descanso.mp3"));
            sonidos.MediaPlayer.Play();
        }
        ...
        public void animacionCansado()
        {
            ...
            this.sonidos.Source = MediaSource.CreateFromUri(new Uri("ms-appx:///AssetsLaprasACE/Cansado.mp3"));
            sonidos.MediaPlayer.Play();
        ...
        public void animacionNoCansado()
        {
            ...
            this.sonidos.Source = MediaSource.CreateFromUri(new Uri("ms-appx:///AssetsLaprasACE/QuitarCansado.mp3"));
            sonidos.MediaPlayer.Play();
        ...
        public void animacionHerido()
        {
            ...
            heridoEstado.Begin();
            caraCansadoHerido.Begin();
            this.sonidos.Source = MediaSource.CreateFromUri(new Uri("ms-appx:///AssetsLaprasACE/PowerDown.mp3"));
            sonidos.MediaPlayer.Play();
        }
        ...
        public void animacionNoHerido()
        {
            ...
            this.sonidos.Source = MediaSource.CreateFromUri(new Uri("ms-appx:///AssetsLaprasACE/PowerUp.mp3"));
            sonidos.MediaPlayer.Play();
        }
        ...
        {
            muerteEstado.Begin();
            this.sonidos.Source = MediaSource.CreateFromUri(new Uri("ms-appx:///AssetsLaprasACE/Muerte.mp3"));
            sonidos.MediaPlayer.Play();
        }
